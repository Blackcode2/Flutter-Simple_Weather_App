              ...
              Center(
                child: Column(
                  ...
                  children: [
                    ...
                    WeatherIcon(weatherMain: weatherMain, imageHeight: 140, imageWidth: 140),
                    const SizedBox(
                      height: 5,
                    ),
                    Text(
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  HourlyWeatherCard(hourlyWeatherMap: hourlyWeatherMap['first']),
                  HourlyWeatherCard(hourlyWeatherMap: hourlyWeatherMap['second']),
                  HourlyWeatherCard(hourlyWeatherMap: hourlyWeatherMap['third']),
                  HourlyWeatherCard(hourlyWeatherMap: hourlyWeatherMap['fourth']),
                ],
              ),
            ),
          )
...
class WeatherIcon extends StatefulWidget {
  ...
  const WeatherIcon({Key? key, required this.weatherMain, required this.imageHeight, required this.imageWidth}) : super(key: key);
...
class _WeatherIconState extends State<WeatherIcon> {
  ...
  Widget iconImage({required String name, required double height, required double width}) {
    return Image.asset(
      name,
      height: height,
      width: width,
...
class HourlyWeatherCard extends StatefulWidget {
  ...
  const HourlyWeatherCard({required this.hourlyWeatherMap, Key? key}) : super(key: key);
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              WeatherIcon(weatherMain: widget.hourlyWeatherMap!['weather'], imageHeight: 70, imageWidth: 70,),
              Text(
